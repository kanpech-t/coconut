...
export default function HeroSection() {
  ...
  return (
    <div className="h-[100dvh] overflow-hidden relative z-[15] flex flex-col justify-center xl:justify-start">
      ...
      {/* mobile text */}
      <div className="absolute left-0 p-6 top-[116px] flex justify-center w-full xl:hidden">
      ...
      {/* desktop text */}
      <div className="absolute left-0 px-[96px] bottom-[96px] justify-center w-full hidden xl:flex">
